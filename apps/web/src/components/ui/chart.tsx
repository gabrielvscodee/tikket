...
// Type for tooltip payload items from Recharts
                ...
                {formatter && item?.value !== undefined && item?.name ? (
                  ...
                  <>
                    {!hideIndicator && (
                      <div
                        className={cn(
                          "shrink-0 rounded-[2px] border-[--color-border] [background-color:var(--color-bg)]",
                          {
...
// Type for legend payload items from Recharts
